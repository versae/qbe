...
WireIt.Wire.prototype.redraw = function() {
   ...
   // 100 par d̩faut, si distance(p1,p2) < 100, on passe en distance/2
...
WireIt.Terminal.prototype.getXY = function() {
    ...
    var layerEl = !!this.container ? this.container.layer.el : document.body;
     ...
     var curleft = curtop = 0;
  	...
  	return [curleft+15+2,curtop+15+2];
};
...
WireIt.Container.prototype.render = function() {
   ...
   if(this.config.ddHandle) {
      ...
      if (this.config.ddHandleCn) {
          this.ddHandle = this.config.ddHandleCn;
      } else {
...
WireIt.Layer.prototype.getWiring = function() {
   ...
   for( i = 0 ; i < this.wires.length ; i++) {
      ...
      if (wire.terminal1.dd.termConfig.type == 'output') {
          var wireObj = { 
          ...
          var wireObj = {
             src: {moduleId: this.containers.indexOf(wire.terminal2.container), terminalId: wire.terminal2.container.terminals.indexOf(wire.terminal2)},
             tgt: {moduleId: this.containers.indexOf(wire.terminal1.container), terminalId: wire.terminal1.container.terminals.indexOf(wire.terminal1)}  
          };          
      }
